...
class BodyComfortGenerator:
    ...
    def __init__(self,pathOfDataFolder,dateOfToday):
        ...
        dateForPred = self.dateOfToday + datetime.timedelta(days=1) # tomorrow of dateOfToday
    ...
    def getUsefulData(self):
        ...
        for j in range(len(number)):
            ...
            newdata1 = [d[33][19:-1], d[225][14:24], d[225][14:-1], d[226][27:-1], d[228][14:-1], d[229][27:-1],
                        d[231][14:-1], d[232][27:-1], d[234][14:-1], d[235][27:-1], d[237][14:-1], d[238][27:-1], d[240][14:-1], d[241][27:-1], d[243][14:-1], d[244][27:-1], d[246][14:-1], d[247][27:-1]]
            newdata2 = []
            ...
            df1 = []
            df1 = [newdata1[1]+' 00:00', newdata1[1]+' 01:00', newdata1[1]+' 02:00', newdata1[1]+' 03:00', newdata1[1]+' 04:00', newdata1[1]+' 05:00', newdata1[1]+' 06:00', newdata1[1]+' 07:00', newdata1[1]+' 08:00', newdata1[1]+' 09:00',
                newdata1[1]+' 10:00', newdata1[1]+' 11:00', newdata1[1]+' 12:00', newdata1[1]+' 13:00', newdata1[1]+' 14:00', newdata1[1]+' 15:00', newdata1[1]+' 16:00', newdata1[1]+' 17:00', newdata1[1]+' 18:00', newdata1[1]+' 19:00', newdata1[1]+' 20:00', newdata1[1]+' 21:00', newdata1[1]+' 22:00', newdata1[1]+' 23:00']
...
class LoadGenerator:
    ...
    def sumUpArea(self):
        ...
        # 用於合併loadfuelareas內部四個地區之負載

        # 檔名格式為 2020_08_19，進行格式轉換
        dateFileType = datetime.date.strftime(self.dateOfToday, '%Y_%m_%d') # 大寫為完整，小寫為簡寫
...
class InputDataGenerator:
    ...
    def __init__( self,pathOfDataFolder, dateOfToday ):
        ...
        self.dateOfToday = dateOfToday
        self.dateForPred = self.dateOfToday + datetime.timedelta(days=1) # tomorrow of dateOfToday

        self.pathOfDataFolder = pathOfDataFolder

        self.BCG = BodyComfortGenerator(pathOfDataFolder=pathOfDataFolder,dateOfToday=self.dateOfToday)

        self.LDG = LoadGenerator(pathOfDataFolder=pathOfDataFolder,dateOfToday=self.dateOfToday)
    ...
    def autoRun(self):
        ...
        finalData.rename(columns={'total_load': 'load'}, inplace=True)
