...
x = pd.read_csv( '../data/sample/sampleInputData.csv', index_col=0 )
...
model.summary()
# load model param
model.load_weights('../data/sample/19-0.0013-0.0015.hdf5')
...
pd.DataFrame(predResult).to_csv("../data/sample/sample.csv",header=None,index=None)
